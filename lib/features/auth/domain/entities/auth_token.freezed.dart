...
@JsonKey(name: 'access_token') String get accessToken;@JsonKey(name: 'access_token_expires_at') String get accessTokenExpiresAt;@JsonKey(name: 'refresh_token') String get refreshToken;@JsonKey(name: 'refresh_token_expires_at') String get refreshTokenExpiresAt; User get user;
...
@override
String toString() {
  return 'AuthToken(accessToken: $accessToken, accessTokenExpiresAt: $accessTokenExpiresAt, refreshToken: $refreshToken, refreshTokenExpiresAt: $refreshTokenExpiresAt, user: $user)';
}
...
@useResult
$Res call({
@JsonKey(name: 'access_token') String accessToken,@JsonKey(name: 'access_token_expires_at') String accessTokenExpiresAt,@JsonKey(name: 'refresh_token') String refreshToken,@JsonKey(name: 'refresh_token_expires_at') String refreshTokenExpiresAt, User user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String accessToken, @JsonKey(name: 'access_token_expires_at')  String accessTokenExpiresAt, @JsonKey(name: 'refresh_token')  String refreshToken, @JsonKey(name: 'refresh_token_expires_at')  String refreshTokenExpiresAt,  User user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthToken() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String accessToken, @JsonKey(name: 'access_token_expires_at')  String accessTokenExpiresAt, @JsonKey(name: 'refresh_token')  String refreshToken, @JsonKey(name: 'refresh_token_expires_at')  String refreshTokenExpiresAt,  User user)  $default,) {final _that = this;
switch (_that) {
case _AuthToken():
return $default(_that.accessToken,_that.accessTokenExpiresAt,_that.refreshToken,_that.refreshTokenExpiresAt,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'access_token')  String accessToken, @JsonKey(name: 'access_token_expires_at')  String accessTokenExpiresAt, @JsonKey(name: 'refresh_token')  String refreshToken, @JsonKey(name: 'refresh_token_expires_at')  String refreshTokenExpiresAt,  User user)?  $default,) {final _that = this;
switch (_that) {
case _AuthToken() when $default != null:
return $default(_that.accessToken,_that.accessTokenExpiresAt,_that.refreshToken,_that.refreshTokenExpiresAt,_that.user);case _:
  return null;
...
class _AuthToken implements AuthToken {
  const _AuthToken({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'access_token_expires_at') required this.accessTokenExpiresAt, @JsonKey(name: 'refresh_token') required this.refreshToken, @JsonKey(name: 'refresh_token_expires_at') required this.refreshTokenExpiresAt, required this.user});
